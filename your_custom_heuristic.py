...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        if (passenger['Sex'] == 'female' and passenger['SibSp']<=2 and passenger['Parch']<=2) or \
           (passenger['Age']<18 and passenger['Pclass']<3 and passenger['SibSp']<=2 and passenger['Parch']<=2):
                predictions[passenger_id] = 1
        else:
            predictions[passenger_id] = 0
    return predictions      
